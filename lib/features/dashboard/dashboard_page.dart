...
class DashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AppLogger.log('DashboardPage.build');
    return page;
  }
  ...
  IconData _portalIcon(String portal) {
    ...
    AppLogger.log('DashboardPage._portalIcon', portal);
    return icon;
  }
  ...
  String _portalTitle(String portal) {
    ...
    AppLogger.log('DashboardPage._portalTitle', title);
    return title;
  }
  ...
  String _portalSubtitle(String portal) {
    ...
    AppLogger.log('DashboardPage._portalSubtitle', subtitle);
    return subtitle;
  }
}
